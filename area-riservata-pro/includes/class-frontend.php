...
class AreaRiservata_Frontend {
    ...
    public function shortcode_login($atts) {
        ...
        if ($this->is_user_logged_in()) {
            if (!headers_sent()) {
                wp_redirect('https://ictende.scherpmind.com/area-riservata/');
                exit;
            }
            return '<div class="ar-redirect-notice"><p>Sei già loggato. <a href="https://ictende.scherpmind.com/area-riservata/">Vai alla dashboard</a></p></div>';
        }
    ...
    public function shortcode_dashboard($atts) {
        if (!$this->is_user_logged_in()) {
            ...
            return '<div class="ar-redirect-notice"><p>Devi effettuare il login. <a href="https://ictende.scherpmind.com/login/">Accedi qui</a></p></div>';
        }
    ...
    /**
     * Login utente - AGGIORNATO CON REDIRECT FISSO
     */
